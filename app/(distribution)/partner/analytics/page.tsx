          ...
          <div className="theme-card rounded-2xl p-6">
            ...
            <ResponsiveContainer width="100%" height={180}>
              <LineChart data={analyticsData.conversionTrend} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
                <CartesianGrid strokeDasharray="3 3" stroke={c.grid} />
                <XAxis dataKey="month" tick={{ fill: c.tick, fontSize: 12 }} axisLine={false} tickLine={false} />
                <YAxis tick={{ fill: c.tick, fontSize: 12 }} axisLine={false} tickLine={false} domain={[20, 50]} />
          ...
          <div className="theme-card rounded-2xl p-6">
            ...
            <ResponsiveContainer width="100%" height={180}>
              <AreaChart data={analyticsData.revenueEstimate} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
                ...
                <CartesianGrid strokeDasharray="3 3" stroke={c.grid} />
                <XAxis dataKey="month" tick={{ fill: c.tick, fontSize: 12 }} axisLine={false} tickLine={false} />
                <YAxis tick={{ fill: c.tick, fontSize: 12 }} axisLine={false} tickLine={false} tickFormatter={v => `$${(v/1000).toFixed(0)}K`} />
